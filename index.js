...
app.post("/api/register/bhopal", async (req, res) => {
...
app.post("/api/register/jaipur", async (req, res) => {
  // Check if a user with the same ID already exists
...
app.get("/api/users/bhopal", async (req, res) => {
  try {
...
app.get("/api/users/jaipur", async (req, res) => {
  try {
